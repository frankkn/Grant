...
- **推播通知**：Firebase Cloud Messaging + Google Cloud Run 後端
...
| 版本 | 日期 | 更新內容 |
|------|------|---------|
| v1.17.0 | 2026-07-21 | 基礎設施：推播後端從 Render 遷移到 Google Cloud Run，每日紀念日／秘密願望解鎖推播改由 Cloud Scheduler 於每天 09:00（台北）觸發；使用者端功能不受影響。文件：README 改為中英雙語（English / 繁體中文） |
